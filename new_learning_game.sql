...
(4, 'debugging', 'บทที่ 4: ช่างซ่อมระบบฟาร์มอัจฉริยะ', 'ฝึกกระบวนการ Debugging โดยสังเกตอาการ วิเคราะห์สาเหตุ จับบล็อกที่ผิด แก้ไข และทดสอบระบบฟาร์มอีกครั้ง', 'การตรวจหาและแก้ไขข้อผิดพลาด', '<div class=\"text-center\"><h4>Smart Farm Debugger</h4><p>สังเกตอาการ จับบั๊ก ซ่อมกฎ และทดสอบระบบฟาร์มให้กลับมาถูกต้อง</p></div>', '2026-03-03 19:33:20');
...
(10, 4, 1, 'บั๊กจิ๋วในโรงคัดแยก', 'สังเกตอาการก่อนแก้ แล้วจับบั๊กคำสั่ง เงื่อนไข และเงื่อนไขกว้างเกินไป', NULL),
(11, 4, 2, 'โรงเรือนรวน ลำดับเพี้ยน', 'ตรวจลำดับเงื่อนไข ค่าตัวเลข และ Else ที่ตกหล่นก่อนทดสอบระบบใหม่', NULL),
(12, 4, 3, 'ศูนย์ควบคุมฟาร์มฉุกเฉิน', 'วิเคราะห์หลายอาการ แยกสาเหตุ และซ่อมหลายระบบด้วยกระบวนการ Debugging', NULL);
