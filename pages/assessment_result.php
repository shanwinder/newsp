...
<body class="assessment-page app-page assessment-result-page"><?php require '../includes/student_navbar.php'; ?>
...
<?php if (!empty($attempt['show_score_to_student'])): ?><div class="assessment-score-summary bg-success bg-opacity-10 rounded-4 p-4 mx-auto my-4"><div class="text-muted">คะแนนของนักเรียน</div><div class="display-4 fw-bold text-success"><?php echo intval($attempt['score']); ?>/<?php echo intval($attempt['full_score']); ?></div><div><?php echo number_format((float)$attempt['percent_score'], 2); ?>%</div></div><?php endif; ?>
