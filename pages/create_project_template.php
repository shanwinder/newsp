...
$projectConfigs = [
    ...
    3 => [
        'title' => 'ออกแบบระบบรดน้ำแบบมีเงื่อนไข',
        'subtitle' => 'กำหนดสถานการณ์และกฎ If-Then-Else ให้ระบบตัดสินใจได้ถูกต้อง',
        'theme' => '#0891b2',
        'icon' => 'bi-droplet-half',
        'fields' => [
            'situation' => ['label' => 'สถานการณ์ของแปลงผัก', 'placeholder' => 'เช่น แปลง A ดินแห้ง ไม่มีฝน / แปลง B ฝนตก / แปลง C ถังน้ำหมด'],
            'rules' => ['label' => 'เงื่อนไข If-Then-Else', 'placeholder' => 'เช่น ถ้าฝนตก -> หยุดรดน้ำ มิฉะนั้นถ้าดินแห้ง -> รดน้ำ'],
            'reason' => ['label' => 'เหตุผลของเงื่อนไขที่เลือก', 'placeholder' => 'อธิบายว่าทำไมต้องตรวจเงื่อนไขนี้ก่อน และป้องกันปัญหาอะไร']
        ],
        'rubric' => 'ตรวจความถูกต้องของเงื่อนไข ความครอบคลุมของกรณี และการอธิบายเหตุผล'
    ],
    4 => [
