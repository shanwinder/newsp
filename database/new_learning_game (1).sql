...
--
-- Host: localhost:8889
-- Generation Time: Jul 07, 2026 at 08:03 AM
...
CREATE TABLE `assessments` (
  `id` int NOT NULL,
  `assessment_type` enum('pretest','posttest') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `version_label` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ชุดที่ 1',
...
CREATE TABLE `assessment_answers` (
  ...
  `selected_choice` enum('A','B','C','D') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `assessment_attempts` (
  ...
  `status` enum('in_progress','submitted','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'in_progress',
...
CREATE TABLE `assessment_questions` (
  ...
  `cognitive_level` enum('remember','understand','apply','analyze') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `correct_choice` enum('A','B','C','D') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `assessment_settings` (
  ...
  `pretest_status` enum('locked','unlocked') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'locked',
  `posttest_status` enum('locked','unlocked') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'locked',
...
CREATE TABLE `site_visits` (
  ...
  `page` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'landing',
...
CREATE TABLE `surveys` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `survey_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'satisfaction',
  `version_label` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ชุดที่ 1',
...
CREATE TABLE `survey_questions` (
  ...
  `category_key` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `category_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `question_no` int NOT NULL,
  `question_text` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `question_type` enum('rating','open_text') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'rating',
...
CREATE TABLE `survey_responses` (
  ...
  `status` enum('submitted','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'submitted'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `survey_settings` (
  ...
  `survey_status` enum('locked','open','closed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'locked',
...
(34, 'demo01', 'นักเรียนทดลอง หนึ่ง', 'ป.4', '$2y$10$DswC7hU5ouhjgaOFermzsOaCw0jNoFvoFkxcEXWq0.J6DxxIsjaEO', 'student', '2026-06-03 09:17:26', '2026-06-16 17:00:02', 'team_6a302d4e92c20', 'solo', 'solo', NULL, 2, 2, 33, NULL, NULL, 'active', NULL, NULL),
...
ALTER TABLE `assessment_answers`
  ...
  ADD CONSTRAINT `fk_answer_question` FOREIGN KEY (`question_id`) REFERENCES `assessment_questions` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `assessment_attempts`
--
ALTER TABLE `assessment_attempts`
  ADD CONSTRAINT `fk_attempt_assessment` FOREIGN KEY (`assessment_id`) REFERENCES `assessments` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_attempt_classroom` FOREIGN KEY (`classroom_id`) REFERENCES `classrooms` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_attempt_school` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_attempt_session` FOREIGN KEY (`learning_session_id`) REFERENCES `learning_sessions` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_attempt_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT,
...
ALTER TABLE `assessment_questions`
  ...
  ADD CONSTRAINT `fk_assessment_questions_game` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`) ON DELETE RESTRICT;
...
--
ALTER TABLE `survey_answers`
  ADD CONSTRAINT `fk_survey_answer_question` FOREIGN KEY (`question_id`) REFERENCES `survey_questions` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_survey_answer_response` FOREIGN KEY (`response_id`) REFERENCES `survey_responses` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `survey_responses`
  ADD CONSTRAINT `fk_survey_response_classroom` FOREIGN KEY (`classroom_id`) REFERENCES `classrooms` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_survey_response_school` FOREIGN KEY (`school_id`) REFERENCES `schools` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_survey_response_session` FOREIGN KEY (`learning_session_id`) REFERENCES `learning_sessions` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_survey_response_survey` FOREIGN KEY (`survey_id`) REFERENCES `surveys` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `fk_survey_response_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT,
