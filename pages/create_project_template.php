...
$projectConfigs = [
    ...
    3 => [
        'title' => 'ออกแบบระบบรดน้ำอัจฉริยะของฉัน',
        'subtitle' => 'กำหนดข้อมูลเซ็นเซอร์ กฎ If-Then-Else ผลลัพธ์ และวิธีทดสอบระบบ',
        'theme' => '#0891b2',
        'icon' => 'bi-droplet-half',
        'fields' => [
            'situation' => ['label' => 'สถานการณ์ของฟาร์ม', 'placeholder' => 'เช่น มีแปลง A ดินแห้ง ไม่มีฝน / แปลง B ฝนตก / แปลง C ถังน้ำหมด'],
            'sensors' => ['label' => 'ข้อมูลเซ็นเซอร์ที่ใช้ตรวจ', 'placeholder' => 'เช่น ความชื้นดิน, ฝนตกหรือไม่, ระดับน้ำในถัง'],
            'rules' => ['label' => 'กฎ If-Then-Else ที่ออกแบบ', 'placeholder' => 'เช่น ถ้าถังน้ำหมด -> แจ้งเตือนเติมน้ำ / มิฉะนั้นถ้าฝนตก -> หยุดรดน้ำ / มิฉะนั้นถ้าดินแห้ง -> รดน้ำ / มิฉะนั้น -> สังเกตต่อ'],
            'reason' => ['label' => 'เหตุผลที่จัดลำดับเงื่อนไขแบบนี้', 'placeholder' => 'อธิบายว่าทำไมต้องตรวจถังน้ำหรือฝนก่อน และป้องกันปัญหาอะไร'],
            'expected_result' => ['label' => 'ผลลัพธ์ที่คาดว่าจะเกิดขึ้น', 'placeholder' => 'เช่น แปลงดินแห้งได้รับน้ำ แปลงฝนตกไม่ถูกรดน้ำเพิ่ม และถังน้ำหมดมีการแจ้งเตือน'],
            'test_plan' => ['label' => 'วิธีตรวจสอบว่าระบบทำงานถูกต้อง', 'placeholder' => 'เช่น ทดลองกับอย่างน้อย 3 สถานการณ์ แล้วดูว่าพืชไม่เหี่ยว ไม่มีน้ำท่วม และมีการแจ้งเตือนเมื่อถังน้ำหมด']
        ],
        'rubric' => 'ตรวจความถูกต้องของเงื่อนไข ความครอบคลุมของกรณี ลำดับการตรวจเงื่อนไข ผลลัพธ์ที่คาดไว้ และวิธีทดสอบระบบ'
    ],
    4 => [
            ...
            <div class="col-lg-4">
                ...
                <div class="work-panel p-4">
                    ...
                    <ul class="mb-0">
                        ...
                        <?php if ($game_id === 3): ?>
                            <li>มีผลลัพธ์ที่คาดไว้และวิธีทดสอบระบบ</li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
