...
(4, 'debugging', 'บทที่ 4: Farm Debug Quest', 'ฝึกกระบวนการ Debugging โดยสังเกตอาการ วิเคราะห์สาเหตุ จับบล็อกที่ผิด แก้ไข และทดสอบระบบฟาร์มอีกครั้ง', 'การตรวจหาและแก้ไขข้อผิดพลาด', '<div class=\"text-center\"><h4>Farm Debug Quest</h4><p>ดูอาการ รันทดสอบ หาจุดผิด ซ่อม และลองใหม่ให้ระบบฟาร์มกลับมาถูกต้อง</p></div>', '2026-03-03 19:33:20');
...
(10, 4, 1, 'แปลงผักหลงทาง', 'ฝึกตรวจหาข้อผิดพลาดจากลำดับคำสั่ง คำสั่งทิศทาง และคำสั่งที่หายไป ผ่านภารกิจหุ่นยนต์รดน้ำในแปลงผัก', NULL),
(11, 4, 2, 'โรงเรือนอัจฉริยะรวน', 'ฝึกตรวจหาข้อผิดพลาดจากเงื่อนไข ลำดับเงื่อนไข ตัวเลข และกรณีอื่น ผ่านระบบโรงเรือนอัจฉริยะ', NULL),
(12, 4, 3, 'เครื่องคัดผลไม้เจอบั๊ก', 'ฝึกตรวจหาข้อผิดพลาดจากการทำซ้ำ การคัดแยกผิด และการซ่อมหลายจุด ผ่านเครื่องคัดผลไม้ก่อนส่งตลาด', NULL);
