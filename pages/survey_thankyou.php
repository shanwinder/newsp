...
<?php require '../includes/student_topbar_head.php'; ?><link rel="stylesheet" href="../assets/css/survey.css"></head>
<body class="survey-page"><?php require '../includes/student_navbar.php'; ?>
