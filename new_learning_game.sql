...
(3, 'condition', 'Smart Farm Manager (Condition)', 'ฝึกการใช้เงื่อนไข If / Else If / Else เพื่อควบคุมสายพานและเครื่องจักรฟาร์มอัจฉริยะ', 'การใช้เงื่อนไข', '<div class=\"text-center\"><h4>Smart Farm Manager</h4><p>ลากบล็อกเงื่อนไขเพื่อควบคุมสายพาน ผลผลิต สัตว์ และโรงเรือน</p></div>', '2026-03-03 19:33:20'),
...
(7, 3, 1, 'โรงคัดแยกผลผลิตของพี่สมปอง', 'ใช้ If / Else If / Else คัดแยกผลผลิตตามสี ขนาด ความสะอาด และความสุก', NULL),
(8, 3, 2, 'หุ่นยนต์เลี้ยงสัตว์อัจฉริยะ', 'ใช้เงื่อนไขจากประเภทสัตว์และค่าสถานะ เช่น ขนและน้ำหนัก', NULL),
(9, 3, 3, 'ผู้ดูแลโรงเรือนไฮเทค', 'ใช้เงื่อนไขจากความชื้น ฝน และอุณหภูมิ เพื่อควบคุมโรงเรือนอัตโนมัติ', NULL),
