...
$projectConfigs = [
    ...
    3 => [
        'title' => 'ออกแบบภารกิจโดรนพิทักษ์ฟาร์มของฉัน',
        'subtitle' => 'สร้างฉากฟาร์ม สถานะแปลง การ์ดเงื่อนไข กฎ If-Then-Else Wave และผลลัพธ์จากโดรน',
        'theme' => '#0891b2',
        'icon' => 'bi-airplane-engines',
        'fields' => [
            'stage_story' => ['label' => 'ชื่อภารกิจและเรื่องราว', 'placeholder' => 'เช่น วิกฤตก่อนเก็บเกี่ยว โดรนต้องช่วยฟาร์มจากแมลง ฝน และแปลงดินแห้ง'],
            'farm_scene' => ['label' => 'ฉากฟาร์มและตำแหน่งสำคัญ', 'placeholder' => 'เช่น ฐานโดรนอยู่มุมขวาล่าง มีแปลง A, B, C และโรงเก็บผลผลิต'],
            'plots' => ['label' => 'ข้อมูลแปลงผักและสถานะ', 'placeholder' => 'เช่น แปลง A ดินแห้ง / แปลง B ฝนตกและดินแห้ง / แปลง C มีแมลง / แปลง D ผลผลิตสุก'],
            'cards' => ['label' => 'การ์ดเงื่อนไขและการ์ดคำสั่ง', 'placeholder' => 'เช่น เงื่อนไข: มีแมลง, ฝนตก, ดินแห้ง, ผลผลิตสุก / คำสั่ง: ไล่แมลง, กลับฐาน, รดน้ำ, เก็บเกี่ยว, สำรวจต่อ'],
            'rules' => ['label' => 'กฎ If-Then-Else ที่เป็นคำตอบ', 'placeholder' => 'เช่น ถ้ามีแมลง -> ไล่แมลง / มิฉะนั้นถ้าฝนตก -> กลับฐาน / มิฉะนั้นถ้าดินแห้ง -> รดน้ำ / มิฉะนั้นถ้าผลผลิตสุก -> เก็บเกี่ยว / มิฉะนั้น -> สำรวจต่อ'],
            'animation' => ['label' => 'Animation หรือภาพผลลัพธ์ที่อยากให้เห็น', 'placeholder' => 'เช่น โดรนบินไปสแกนแปลง พ่นสมุนไพรไล่แมลง ปล่อยละอองน้ำ หรือหย่อนตะกร้าเก็บผลผลิต'],
            'feedback' => ['label' => 'ผลลัพธ์และ Feedback เมื่อผู้เล่นทำถูกหรือผิด', 'placeholder' => 'เช่น ถ้าตรวจดินแห้งก่อนฝนตก แปลง A น้ำท่วม เพราะโดรนรดน้ำกลางฝน ลองย้ายฝนตกขึ้นมาก่อนดินแห้ง']
        ],
        'rubric' => 'ตรวจความสนุกของภารกิจโดรน ความถูกต้องของเงื่อนไข ความครอบคลุมของ Wave ลำดับการตรวจเงื่อนไข Animation ที่สื่อผลลัพธ์ และ Feedback ที่ช่วยให้เพื่อนแก้กฎได้'
    ],
    4 => [
            ...
            <div class="col-lg-4">
                ...
                <div class="work-panel p-4">
                    ...
                    <ul class="mb-0">
                        ...
                        <?php if ($game_id === 3): ?>
                            <li>มีโดรน ฐานโดรน และแปลงผักที่มีสถานะชัดเจน</li>
                            <li>มี Wave หรือภารกิจให้เพื่อนเล่น</li>
                            <li>มีแนวคิด Animation ที่แสดงผลจากกฎของโดรน</li>
