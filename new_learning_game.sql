...
(3, 'condition', 'บทที่ 3: ผู้จัดการฟาร์มอัจฉริยะ', 'ฝึกใช้เงื่อนไขควบคุมระบบฟาร์มอัตโนมัติ', 'การใช้เงื่อนไข', '<div class=\"text-center\"><h4>Smart Farm Manager</h4><p>ลากบล็อกเงื่อนไขและคำสั่งเพื่อควบคุมสายพาน ผลผลิต สัตว์ และโรงเรือน</p></div>', '2026-03-03 19:33:20'),
...
(7, 3, 1, 'โรงคัดแยกผลผลิตของพี่สมปอง', 'เกมที่ 1 ฝึกใช้ If เพื่อคัดแยกผลผลิตบนสายพาน', NULL),
(8, 3, 2, 'หุ่นยนต์เลี้ยงสัตว์อัจฉริยะ', 'เกมที่ 2 ฝึกใช้ If / Else เพื่อดูแลสัตว์ตามเงื่อนไข', NULL),
(9, 3, 3, 'ผู้ดูแลโรงเรือนไฮเทค', 'เกมที่ 3 ฝึกใช้ If / Else If / Else เพื่อควบคุมโรงเรือนอัตโนมัติ', NULL),
