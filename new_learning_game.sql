...
(3, 'condition', 'เครื่องรดน้ำอัจฉริยะ (Condition)', 'ฝึกการใช้เงื่อนไข If-Then-Else เพื่อเลือกการทำงานที่เหมาะสมกับสถานการณ์ในเกม', 'การใช้เงื่อนไข', '<div class=\"text-center\"><h4>ภารกิจฟาร์มแก้ปัญหา</h4><p>ใช้บล็อกเงื่อนไขเพื่อสร้างระบบรดน้ำอัตโนมัติ</p></div>', '2026-03-03 19:33:20'),
...
(7, 3, 1, 'เช็คดินแห้งหรือเปียก', 'ใช้เงื่อนไข ถ้าดินแห้งให้รดน้ำ และถ้าดินชื้นให้หยุดรดน้ำ', NULL),
(8, 3, 2, 'รับมือฝนฟ้าคะนอง', 'ตรวจเงื่อนไขฝนตกก่อน จากนั้นจึงตรวจว่าดินแห้งหรือชื้น', NULL),
(9, 3, 3, 'ระบบน้ำครอบจักรวาล', 'ประยุกต์ใช้หลายเงื่อนไขเพื่อตัดสินใจให้เหมาะกับแปลงผักหลายแปลง', NULL),
