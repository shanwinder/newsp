...
(function () {
    ...
    const config = {
        ...
        subtitle: 'Debug Mode: ซ่อมกฎ IF ที่ทำให้โรงคัดผักส่งผลผลิตผิดทาง',
        resultText: 'คุณซ่อมกฎ IF ของโรงคัดผักครบทั้ง 3 ภารกิจแล้ว',
        levels: [
            {
                id: '10-1',
                stageId: 10,
                title: '10-1 ซ่อมกฎล้างแครอทเปื้อนโคลน',
            ...
            },
            {
                id: '10-2',
                stageId: 10,
                title: '10-2 ซ่อมกฎตรวจผักกาดมีหนอน',
            ...
            },
            {
                id: '10-3',
                stageId: 10,
                title: '10-3 ซ่อมกฎคัดแยกมันฝรั่งงอก',
