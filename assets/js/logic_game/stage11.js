...
(function () {
    const config = {
        ...
        subtitle: 'ซ่อมกฎฟาร์มอัจฉริยะ: ซ่อมกฎ IF / ELSE',
        resultText: 'คุณซ่อมกฎ IF / ELSE ของโรงคัดผลไม้ครบทั้ง 3 ภารกิจแล้ว',
        levels: [
            {
                id: '11-1',
                stageId: 11,
                title: '11-1 ส้มใหญ่ / ส้มเล็ก',
